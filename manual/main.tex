...
Para o treinamento e classificação dos padrões são utilizados três classificadores
diferente. Definidos por, quantidade baixa de amostras para os ensaios.
São eles: AdaBoost, Modelos de Máquina de Vetor de Suporte e Árvores 
Randomizadas. 
...
\subsubsection{Árvores Randomizadas}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
