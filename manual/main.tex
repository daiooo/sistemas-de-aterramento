...
A exemplificação do esquema de ligação da alimentação é vista na Figura \ref{fig_esquema_ligacao_alimentacao}. Onde mostra duas vistas, vista frontal da fonte e vista
...
Quando a malha de aterramento é projetada, não se leva em consideração 
os efeitos da altas frequencias na malha. Pois uma malha estara
submetida, na maiorias dos casos, a frequencia de operação da rede 
elétrica 60 Hz. Uma vez da incidência de um raio as caractéricas 
capacitivas e indutivas da malha irão surtir efeito.

A fonte de impulso é portanto o elemento que irá extrair a impedância
caracteristica de cada malha, com a leitura de corrente e tensão. 
Quando da descarga de um capacitor, carregado a aproximadamente 1000 V, 
é feito na malha de aterramento.
...
\begin{tabular}{|l|l|}
\hline
Aplicação                & \begin{tabular}[c]{@{}l@{}}Analisar e identificar um topologia desconhecida \\ de aterramento. Fornecendo a disposição/topologia das \\ hastes em um aterramento até então desconhecido.\end{tabular}                          \\ \hline
Método de  identificação & \begin{tabular}[c]{@{}l@{}}É injetado no solo uma tensão elétrica, mede-se \\ o sinal de tensão e corrente resultante. \\ Com isto analisa-se por meio de algorítimos\\ inteligentes qual a topologia.\end{tabular} \\ \hline
Precisão                 & Aproximadamente 90\%.                                                                                                                                                                                               \\ \hline
Alimentação              & Rede de 220V ~ 60Hz, linha monofásica sem terra.                                                                                                                                                                    \\ \hline
Porta de Comunicação     & USB                                                                                                                                                                                                                 \\ \hline
Peso                     & 20 kg CHUTEEE, sem a presença do computador.                                                                                                                                                                                \\ \hline
